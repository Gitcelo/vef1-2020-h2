(function () {
	...
	/* eslint-disable*/
	//Disable-um því við fengum fallið frá Óla og viljum ekki fikta í því
	...
	function formatTime(milliseconds) {
	  ...
	  if (hour <= 24) return "Fyrir ".concat(hour, " klukkustundum s\xED\xF0an");
	  var day = Math.floor(hour / 24);
	  if (day === 1) return 'Fyrir 1 degi síðan';
	  if (day <= 7) return "Fyrir ".concat(day, " d\xF6gum s\xED\xF0an");
	  var week = Math.floor(day / 7);
	  if (week === 1) return 'Fyrir 1 viku síðan';
	  if (week <= 4) return "Fyrir ".concat(week, " vikum s\xED\xF0an");
	  var month = Math.floor(day / 30);
	  if (month === 1) return 'Fyrir 1 mánuði síðan';
	  if (month <= 11) return "Fyrir ".concat(month, " m\xE1nu\xF0um s\xED\xF0an");
	  var year = Math.floor(month / 12);
	  if (year === 1) return 'Fyrir 1 ári síðan';
	  return "Fyrir ".concat(year, " \xE1rum s\xED\xF0an");
	}
	...
	function _makeVideos() {
	  _makeVideos = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
	    var data, mum, elem, cat, videodata;
	        ...
	        switch (_context2.prev = _context2.next) {
	          ...
	          case 5:
	            ...
	            cat.forEach(function (category) {
	              ...
	              var videocat = category.videos;
	              videocat.sort(function (a, b) {
	                return a - b;
	              });
	              videocat.forEach(function (videoid) {
	...
	function displayVideo() {
	  return _displayVideo.apply(this, arguments);
	}

	function _displayVideo() {
	  _displayVideo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	    var data, videoID, videoIDA, videoIDB, videoIDC, videoIDD, video, body, tengdMyndbond;
	    return regeneratorRuntime.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	          ...
	          case 2:
	            ...
	            videoIDA = videoID.split('?')[1];
	            videoIDB = videoIDA.split('&')[0];
	            videoIDC = videoIDB.split('=')[1];
	            videoIDD = Number(videoIDC);
	            videoID = videoIDD;
	            _context.next = 11;
	            return search(videoID, data.videos);
