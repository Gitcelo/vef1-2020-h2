	    ...
	    return regeneratorRuntime.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          ...
	          case 2:
	            data = _context.sent;
	            videoID = Number(/\?id=([^\?]+)/.exec(window.location.href)[1]);
	            _context.next = 6;
	          ...
	          case 6:
	            ...
	            video.related.forEach(function (id) {
	              var relatedVideo = search(id, data.videos);
	              console.log(relatedVideo);

	              if (relatedVideo == null) ; else {
	                var daughter = element('div', {
	                  'class': 'col col-4 col-12-sm video-card'
	                }, null, element('div', {
	                  'class': 'video-thumbnail'
	                  ...
	                  'class': 'video-image',
	                  'src': relatedVideo.poster,
	                  'alt': ''
	                }, ' ')), element('div', {
	                  'class': 'video-info'
	                }, null, element('h3', {
	                  'class': 'video-name'
	                }, null, relatedVideo.title), element('p', {
	                  'class': 'video-upload'
	                }, null, "Fyrir ".concat(relatedVideo.created, " d\xF6gum s\xED\xF0an"))));
	                tengdMyndbond.appendChild(daughter);
	              }
	            });
	            body.appendChild(el('main', element('section', {
	              'class': 'video-view grid'
	            }, null, el('h1', video.title), el('video', element('source', {
	              'src': video.video,
	              'type': 'video/mp4'
	            }, null, ' ')), element('div', {
	              ...
	              'class': 'video-controls__img button__unactive',
	              'src': 'img/play.svg'
	            }, null, " ")), element('button', {
	              'class': 'video-controls__button'
	            }, {
	            ...
	            }, null, el('p', video.description))), tengdMyndbond));
